export const FAQs = () => {
    const FAQCard = () => {
      return (
        ...
        [&:not(:hover)]:opacity-80'>
            ...
            <h4 className='py-2 font-bold text-normal'>Account</h4>
            <h5 className='text-xs text-graybit-200'>User settings, templates, groups. </h5>
          </div>
        // </button>
      )
    }
    ...
    return (
      <section className='pt-8 text-graybit-400 px-6'>
        <h1 className='font-bold text-5xl pb-2'>FAQs</h1>
        <h3 className='text-graybit-200 px-10'>Quickly find our hand-crafted answers to your questions</h3>
        ...
        <article className='text-graybit-200'>
          ...
          <hr className='mt-4 border-[1.5px]'/>
