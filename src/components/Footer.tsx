    ...
    return (
        <section className="pt-10 grid grid-cols-2 grid-rows-2 md:w-[50%]">
            <article className="mb-5">
                <h2 className="text-xl mb-2 font-bold text-graybit-500">Product</h2>
                <ul className="flex flex-col items-center">
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                </ul>
            ...
            <article className="mb-5">
                <h2 className="text-xl mb-2 font-bold text-graybit-500">Company</h2>
                <ul className="flex flex-col items-center">
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
            ...
            <article className="mb-5">
                <h2 className="text-xl mb-2 font-bold text-graybit-500">Support</h2>
                <ul className="flex flex-col items-center">
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
            ...
            <article className="mb-5">
                <h2 className="text-xl mb-2 font-bold text-graybit-500">Get Started</h2>
                <ul className="flex flex-col items-center">
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
                    <div className="w-20 h-4 my-1 bg-graybit-100 rounded-xl"></div>
